...
!(function (i) {
  window.dialog = {
    ...
    alert: function (a) {
      ...
      (o += '<div class="dialog-border"></div>'),
        (o += '<div class="dialog-title">' + a.title + "</div>"),
        (o += '<div class="dialog-message">' + a.message + "</div>"),
        (o += '<div class="dialog-close">&times;</div>'),
        (o += '<div class="dialog-confirm">' + a.button + "</div>"),
        (o += '<div class="dialog-clearFloat"></div>'),
        (o += "</div>"),
        dialog.holder.find("td").append(o);
      var d = i("#" + l),
        e = d.find(".dialog-confirm"),
        n = d.find(".dialog-close");
      !0 === a.required && n.remove(),
        d.attr("data-dialog-position", a.position),
        d.attr("data-dialog-animation", a.animation),
        dialog.injectDialog(),
        e.one("click.dialog", function () {
          a.callback(!0);
        }),
    ...
    prompt: function (a) {
      ...
      (e += '<div class="dialog-border"></div>'),
        (e += '<div class="dialog-title">' + a.title + "</div>"),
        (e += '<div class="dialog-message">' + a.message + "</div>"),
        a.select
          ? a.item.players.forEach(function (i) {
              e += '<div class="select" data-player="' + i.player + '">' + i.label + "</div>";
            })
          : (e += "<label><input " + o + " /></label>"),
        (e += '<div class="dialog-close">&times;</div>'),
        a.select || (e += '<div class="dialog-confirm">' + a.button + "</div>"),
        (e += '<div class="dialog-clearFloat"></div>'),
        (e += "</div>"),
        dialog.holder.find("td").append(e);
      var n = i("#" + l);
      if (a.select) t = n.find(".select");
      else var t = n.find(".dialog-confirm");
      var s = n.find(".dialog-close"),
        g = n.find("input");
      !0 === a.required && s.remove(),
        n.attr("data-dialog-position", a.position),
        n.attr("data-dialog-animation", a.animation),
        dialog.injectDialog(),
        t.bind("click.dialog", function () {
          var l = g.val();
          ...
          if ((!0 === a.required && "" === l && (o = !1), !o))
            return (
              n
                .one("webkitAnimationEnd oanimationend msAnimationEnd animationend", function (i) {
    ...
    confirm: function (a) {
      ...
      (o += '<div class="dialog-border"></div>'),
        ...
        (o += '<div class="dialog-message">' + a.message + "</div>"),
        (o += '<div class="dialog-close">&times;</div>'),
        (o += '<div class="dialog-cancel">' + a.cancel + "</div>"),
        (o += '<div class="dialog-confirm">' + a.button + "</div>"),
        (o += '<div class="dialog-clearFloat"></div>'),
        (o += "</div>"),
        dialog.holder.find("td").append(o);
    ...
    showDialog: function () {
      ...
      "absolute" === a.attr("data-dialog-position")
        ? (dialog.holder.removeClass("dialog-fixed"), dialog.holder.css("top", i(window).scrollTop()))
        : (dialog.holder.addClass("dialog-fixed"), dialog.holder.css("top", "")),
        i(window).trigger("resize.dialog"),
        i(".dialog-alert").hide(),
        a.show(),
        setTimeout(function () {
        ...
        i("html").addClass("dialogIsVisible");
    },
    ...
    appendDialogHolder: function () {
      dialog.holder ||
        (i("body").append('<div id="dialog-overlay"></div><div id="dialog-holder"><table id="dialog-center"><tr><td></td></tr></table></div>'),
    ...
    removeDialogHolder: function () {
      dialog.unbindDialogGlobalEvents(),
        ...
        i("html").removeClass("dialogHolderIsVisible");
    },
    close: function () {
      var a = i(".dialog-alert:not(.dialog-closing):first");
      a.addClass("dialog-closing")
    ...
    bindDialogGlobalEvents: function () {
      dialog.holder.add(dialog.overlay).bind("click.dialog", function (a) {
        ...
        i(document).bind("keydown.dialog", function (a) {
          ...
          if (0 !== l.length) return 13 == a.keyCode ? (l.find(".dialog-confirm").trigger("click"), !1) : void 0;
        }),
