!(function (e) {
  e.fn.contextMenu = function (t, n) {
    var o = e("body"),
      i = { name: "", offsetX: 15, offsetY: 5, beforeShow: e.noop, afterShow: e.noop },
      s = e.extend(i, n || {}),
      a = {},
        ...
        e.each(o, function (t, n) {
          ...
          if ((t && s.append('<div class="site-cm-separ">'), n.length)) {
            ...
            e.each(n, function (n, i) {
              var l,
                u = e("<li>" + i.text + (e.isArray(i.items) && i.items.length ? f(i.items) : "") + "</li>");
        ...
        e(this).on("contextmenu", function (t) {
          (e.isFunction(s.beforeShow) && !1 === s.beforeShow.call(this, t)) ||
            ...
            (function () {
              ...
              .show()
              .offset({ left: t.clientX + s.offsetX, top: t.clientY + s.offsetY }),
